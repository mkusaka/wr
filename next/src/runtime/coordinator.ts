...
export class CoordinatorBridge {
    ...
    async guidance(): Promise<string> {
        ...
        return [
            ...
            "Planning scope is not operator, validation, deployment, merge or trust-bypass permission. Native subagents require explicit adapter binding; never reuse this root's context.",
