...
const fields: Record<string, string[]> = {
    "coordination.enable": ["repository", "environment", "runtimes", "title", "work", "checks"],
    "coordination.revoke": ["grant", "reason"],
    "coordination.open": ["runtime", "environment", "session", "actor", "invocation"],
    "coordination.dispatch": ["toolId", "inputDigest"],
    "coordination.dispatch.close": ["dispatch"],
    "coordination.credentials": [],
    "coordination.stop": ["processStopped"],
    "coordination.window": ["window"],
    "coordination.note": ["kind", "summary", "reason"],
    "work.claim": ["work", "retry", "reason"],
    "work.yield": ["reason"],
    ...
    "execution.next": ["grant", "launchId", "environment", "runtime", "role", "mode", "session", "continuedFrom", "metadata"],
